...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[var(--background)] py-12 md:py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12 pt-8 md:pt-12 border-t border-[var(--border-color)]">
              ...
              {socials.map((social) => (
                <li key={social.url}>
                  <Link 
                    ...
                    className="text-[var(--foreground)] opacity-80 hover:text-[var(--accent)] transition-colors flex items-center gap-2 p-2 rounded-full hover:bg-[var(--card-background)]"
