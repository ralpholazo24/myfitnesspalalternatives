...
export default function Hero() {
  return (
    <section className="w-full flex flex-col items-center justify-center py-12 md:py-24 px-4 bg-[var(--background)] text-[var(--foreground)]">
      <h1 className="text-4xl md:text-7xl font-mono font-bold text-center mb-4 md:mb-6">
        The Complete <span style={{ color: "var(--accent)" }}>MyFitnessPal</span>™ Alternatives List
      </h1>
      <p className="text-lg md:text-2xl text-center max-w-2xl mb-6 md:mb-8">
